...
func main() {
	...
	dbInsert := `INSERT INTO public.access_token VALUES (1, 'asdfghjkl');
	INSERT INTO public.empcars VALUES (1, 'ranjeet', '213654');
	...
	checkErr(err)
	createSchema(db, &apartment_user.AccessToken{}, &user_favorite_apartment.UserFavoriteApartment{}, &apartment_user.ApartmentUser{}, &apartment.Apartment{}, &car.EmpCar{}, &gorsk.Company{}, &gorsk.Location{}, &gorsk.Role{}, &gorsk.User{})
